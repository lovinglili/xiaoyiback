...
var storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    let _filename = _baseName + _extName // 最终的名字，拼上时间戳，防止覆盖

    // 将图片的路径放入到req.body中的，下个中间件就可以取用了
    req.body.pic = '/uploads/logos/' + _filename
    cb(null, _filename)
  }
})
...
function fileFilter (req, file, cb) {
  let _flag = file.mimetype.startsWith('image/jpeg')
